...
~/Downloads/maelstrom/maelstrom test -w broadcast --bin ./bin/Release/net7.0/publish/Broadcast --node-count 5 --time-limit 20 --rate 10 --nemesis partition --log-stderr true
